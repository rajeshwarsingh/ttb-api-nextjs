...
const CacheNewsHomepag = mongoose.models.cachenewsentertainment || mongoose.model('cachenewsentertainment', cacheSchema);
...
async function getHomepageNews() {
  const apiRes = await fetch(`https://newsapi.org/v2/top-headlines?category=entertainment&apiKey=${config.newsAPIKey}&pageSize=30pageSize=5&country=in`, {
    headers: {
