...
const CacheNewsHomepag = mongoose.models.cachenewstechnology || mongoose.model('cachenewstechnology', cacheSchema);
...
async function getHomepageNews() {
  const apiRes = await fetch(`https://newsapi.org/v2/top-headlines?category=technology&apiKey=${config.newsAPIKey}&pageSize=30&country=in`, {
    headers: {
