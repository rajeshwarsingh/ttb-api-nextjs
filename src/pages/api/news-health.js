...
const CacheNewsHomepag = mongoose.models.cachenewshealth || mongoose.model('cachenewshealth', cacheSchema);
...
async function getHomepageNews() {
  const apiRes = await fetch(`https://newsapi.org/v2/top-headlines?category=health&apiKey=${config.newsAPIKey}&pageSize=30pageSize=5&country=in`, {
    headers: {
